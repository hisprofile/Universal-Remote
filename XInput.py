...
You can get the required state using get_state()"""
    ...
    return {"dpadUp" : int(bool(wButtons & 0x0001)),
            "dpadDown" : int(bool(wButtons & 0x0002)),
            "dpadLeft" : int(bool(wButtons & 0x0004)),
            "dpadRight" : int(bool(wButtons & 0x0008)),
            "Start" : int(bool(wButtons & 0x0010)),
            "Back" : int(bool(wButtons & 0x0020)),
            "leftThumb" : int(bool(wButtons & 0x0040)),
            "rightThumb" : int(bool(wButtons & 0x0080)),
            "leftBumper" : int(bool(wButtons & 0x0100)),
            "rightBumper" : int(bool(wButtons & 0x0200)),
            "btnSouth" : int(bool(wButtons & 0x1000)),
            "btnEast" : int(bool(wButtons & 0x2000)),
            "btnWest" : int(bool(wButtons & 0x4000)),
            "btnNorth" : int(bool(wButtons & 0x8000)),
        }
...
You can get the required state using get_state()"""
    ...
    return {'leftTrigger': normLT, 'rightTrigger': normRT}
...
You can get the required state using get_state()"""
    ...
    if (magR > XINPUT_GAMEPAD_RIGHT_THUMB_DEADZONE):
        ...
        magR = 0
    #print({'Left JoystickX': normLX * normMagL, 'Left JoystickY': normLY * normMagL, 'Right JoystickX': normRX * normMagR, 'Right JoystickY': normRY * normMagR})
    return {'leftJoystickX': normLX * normMagL, 'leftJoystickY': normLY * normMagL, 'rightJoystickX': normRX * normMagR, 'rightJoystickY': normRY * normMagR}
